...
2. Configure your miner IP address in the example scripts or use environment variables:
   ```bash
...
- These examples import from the built library (`../dist`)
- For development, you can modify imports to use `../src` directly with ts-node
